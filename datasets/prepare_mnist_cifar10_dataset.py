...
parser.add_argument('--dataset', default='cifar-10', type=str, help='Dataset to be downloaded (e.g. cifar-10, mnist, fmnist)')
parser.add_argument('--save_dir', default='../data', type=str, help='Path to save the data')
