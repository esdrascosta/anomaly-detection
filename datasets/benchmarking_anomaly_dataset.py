"""
datasets.py from https://github.com/olivesgatech/gradcon-anomaly/blob/master/datasets.py
References:
    1. Kwon et al, Backpropagated Gradient Representations for Anomaly Detection
...
class AnomalyDataset(data.Dataset):
    def __init__(self, root, split='train', in_channel=3, transform=None, target_transform=None, inlier_class=None):
        ...
        Args:
            ...
            inlier_class (int): An inlier class
        """
    ...
    def __getitem__(self, index):
        ...
        binarization = 0 if label == self.inlier_class else 1

        return img, binarization
